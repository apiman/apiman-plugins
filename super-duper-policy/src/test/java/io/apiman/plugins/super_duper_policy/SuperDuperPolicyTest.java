 ...
 * Test the {@link SuperDuperPolicy}.
 *
 */

@TestingPolicy(SuperDuperPolicy.class)
@SuppressWarnings({ "nls" })

public class SuperDuperPolicyTest extends ApimanPolicyTest {
    ...
    public void testSimple() throws Throwable {
        ...
        request.contextAttribute(SuperDuperPolicy.AUTHENTICATED_USER_ROLES, userRoles);
