...
public class SuperDuperConfig {
    ...
    private List<SuperDuperRule> rules = new ArrayList<>();
     ...
     * Constructor.
     */
    public SuperDuperConfig() {
    }

    /**
     * @return the rules
     */
    public List<SuperDuperRule> getRules() {
        return rules;
    }
     ...
     */
    public void setRules(List<SuperDuperRule> rules) {
        this.rules = rules;
    }
